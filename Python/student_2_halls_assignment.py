...
@author: Engin-Eer
---
Goal of this Project is to assign students to residences.
Each student:
must be placed somewhere; if not, create a list of non-assigned people to be notified.
must be placed according to preferences. If no solution exist, create a list to be clarified with needed questions.
must be placed in preferred room type.
...
should be placed placed in Single rooms with priority if Master's student.

Be careful to ensure an equal distribution among halls for nationalities to prioritize variety.
---
"""
###################################
###################################
...
#4)Quality Control & Accuracy Test Process:
